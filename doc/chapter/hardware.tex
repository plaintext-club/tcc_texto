...
Neste projeto foi escolhido o microcomputador Raspberry Pi 3 B+, exibido na Figura \ref{fig:rpi}, desenvolvido no final de 2014 pela \emph{Raspberry Pi Foundation} com as seguintes especificações:
...
\itemsep0em
    ...
    \item memória: 1GB LPDDR2 SDRAM;
    \item armazenamento: cartão \emph{Micro SD}.
\end{enumerate}
...
Esse dispositivo tem configuração de  Entrada e Saída para 5 pinos de acordo com a Figura \ref{fig:BH1750_pinout}, sendo eles: alimentação (Vcc e Terra), pinos para o protocolo I2C (SCL e SDA) e um pino analógico para o valor do sensor, nomeado como ADDR.
...
A comunicação que é mais utilizada para esse dispositivo é a \emph{adhoc} dh11.
